...
parser.add_argument('-out', dest='out', type=str, required=True, help='Path to save the prediction')
...
filename = os.path.basename(args.image).split('.')[0]
outpath = os.path.join(args.out, filename) + '.semantic'
