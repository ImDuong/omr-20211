...
parser.add_argument('-output', dest='out_file', type=str, help='Path to the output file.')
...
for w in str_predictions[0]:
    ...
    output_str += int2word[w] + " "
    # print('\t'),

if args.out_file:
    try:
        f = open(args.out_file, 'wt', encoding='utf-8')
        f.write(output_str)
        print("Output is saved in ", args.out_file)
    except Exception as e:
        print("Error occurs: ", e)
else:
    print("Output is showed in terminal: ")
    print(output_str)